...
echo -e "\n\n"
echo -e "+---------------------------------------------+"
echo -e "| Iniciando Processo de Teste do Exercicio 06 |"
echo -e "+---------------------------------------------+\n\n"    
...
then
    ...
    do
        ...
        ./$executavel < $i > ./saidas_teste/$name.txt
        
        diff ./saidas_teste/$name.txt ./saidas_padrao/"saida_"$name.txt > /dev/null
        diff ./saidas_teste/$name.txt ./saidas_padrao/"saida_"$name.txt > ./saidas_teste/"erros_"$name.txt
        ...
        then 
            ...
            rm -Rf ./saidas_teste/$name.txt
            rm -Rf ./saidas_teste/"erros_"$name.txt
        fi
        if [ $rc == 1 ];
        then
    ...
    then
        ...
        echo -e "\nConsulte seus erros nos arquivos da pasta 'saidas_teste'"
    fi
fi
